...
//   return (
//     <section className="relative min-h-screen flex flex-col items-center justify-center bg-black text-white overflow-hidden px-4 sm:px-8 py-20">
     
//       <h1 className="absolute top-10 right-6 sm:top-16 sm:right-16 text-3xl sm:text-5xl font-[Zen_Dots] tracking-wider bg-linear-to-r from-pink-400 to-purple-400 text-transparent bg-clip-text">
//         ABOUT
//       </h1>

//       <div className="relative flex flex-col lg:flex-row items-center justify-center gap-10 lg:gap-20 w-full h-full mt-10">
        
//         <div className="w-60 h-60 sm:w-72 sm:h-72 bg-linear-to-b from-purple-500 to-pink-500 rotate-45 rounded-[2.5rem] flex items-center justify-center shadow-lg">
//           <div className="-rotate-45 text-center text-white font-bold bg-white/10 backdrop-blur-md rounded-xl px-4 py-3">
...
//                 target="_blank"
//                 rel="noreferrer"
//                 className="text-sky-800 hover:text-sky-300 ml-1 underline underline-offset-2"
//               >
//                 KHUSHI BHASKAR
//               </a>
//             </p>
...
//               target="_blank"
//               rel="noreferrer"
//               className="block text-xs sm:text-sm text-gray-300 hover:text-white mt-1"
//             >
//               github.com/Khushi-bhaskar01
//             </a>
//           </div>
//         </div>
//         <div className="relative z-10 w-72 sm:w-md md:w-140 h-72 sm:h-112 md:h-140 bg-linear-to-b from-purple-400 to-pink-400 rotate-45 rounded-[3rem] flex items-center justify-center shadow-[0_0_60px_rgba(255,255,255,0.3)]">
//           <p className="-rotate-45 text-white text-xs sm:text-sm md:text-lg font-light text-center px-4 sm:px-8 leading-relaxed">
//             DevSource is a development club under ACM USICT, GGSIPU, dedicated to fostering a community of passionate tech enthusiasts.
//             We focus on Web, App, and Game Development, while also encouraging Open Source contributions.
...
//         <div className="w-60 h-60 sm:w-72 sm:h-72 bg-linear-to-b from-green-300 to-pink-400 rotate-45 rounded-[2.5rem] flex items-center justify-center shadow-lg">
//           <div className="-rotate-45 text-center text-black font-bold bg-white/50 backdrop-blur-md rounded-xl px-4 py-3">
//             <p className="text-sm sm:text-base leading-tight">
//               VICE LEAD:
//               <a
