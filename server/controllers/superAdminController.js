...
export const addAdmin = async (req, res, next) => {
  try {
    ...
    // 1. Check if requester is the Super Admin (ENV match explicitly)
    const isSuper = req.user && req.user.email.toLowerCase() === process.env.SUPER_ADMIN_EMAIL?.toLowerCase();
